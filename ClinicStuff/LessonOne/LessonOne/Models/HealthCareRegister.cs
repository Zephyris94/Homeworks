...
namespace LessonOne.Models
{
  ...
  {
    private List<HealthcareBuilding> _hcBuildings
  = new List<HealthcareBuilding>();
    ...
    public List<HealthcareBuilding> Buildings
    {
      get { return _hcBuildings; }
    }
    public void AddNewBuilding(int id,
      BuildingType type, int carCount, int floorCount, int maxPatients)
    {
      ...
      switch (type)
      {
        ...
        case BuildingType.Hospital:
          ...
          b = new Hospital(id, floorCount, carCount, maxPatients);
          break;
        case BuildingType.Infirmary:
          ...
          b = new Infirmary(id, floorCount, carCount, maxPatients);
          break;
        default:
    ...
    //public List<HealthCareRegister> FindMostEmpty(List)
